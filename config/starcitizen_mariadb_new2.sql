...
CREATE TABLE `categorie_transport` (
  ...
  `nom` varchar(155) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `img_cat` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_user_cat` int(10) NOT NULL,
  `date_cat` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `categories_especes`
  MODIFY `id_categ_espece` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `faiblesses`
  MODIFY `id_faiblesse` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `forces`
--
ALTER TABLE `forces`
  MODIFY `id_force` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
