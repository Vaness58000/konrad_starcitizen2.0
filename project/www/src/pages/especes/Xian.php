...
<section class="page_generale">
    ...
    <h1><img src="img/account_corners.png" alt="deco">&ensp; Xi'an</h1>
    <div class="info_generale">
        <p>Les hommes les surnomment les visqueux, ce qui est un terme très offensant, y compris du point de vue de certains humains. Les Xi'an sont des êtres vivants anthropomorphiques d'allure reptilienne pouvant vivre plusieurs centaines d'années.</p>
        <img src="src/img/xian4.jpg" alt="xian">
    </div>
    <div class="info_generale">
        <h2>Histoire</h2>
        ...
        <img src="src/img/Xian.png" alt="xian">
