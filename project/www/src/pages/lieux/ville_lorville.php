...
<section class="page_generale">
    ...
    <div class="info_generale">
        <h2>Transit</h2>
        <p>Le transit de Lorville est l'un des plus développés dans Star Citizen à l'heure actuelle. Il comprend 5 Lignes dont 3 lignes internes (Commerce, Central et spaceport) et 2 lignes périphériques (Est et Ouest).Ces lignes desservent au total 10 Stations, avec 4 Stations principales en centre ville (Teasa, Central, Leavsden et Metro center) et 6 Stations périphériques correspondant à chacune des portes de la ville. Elles s'organisent en étoile autour de la Station Metro center par laquelle passent toutes les lignes à l’exception de Commerce Line. Chaque station est desservie comme suit:</p>
        <li>Teasa Spaceport et Central Station : Commerce Line</li>
        <li>Central Station et Leavsden Square : Central Line</li>
        <li>Leavsden Square et Metro Center : à pied</li>
    ...
    <div class="info_generale">
        <h2>Metro Center</h2>
        <p>La station Metro Center est le cœur de la ville: elle pompe les passagers au travers de la totalité de la ville. On accèdera à cette station immédiatement en se réveillant à Lorville après connexion, depuis les quartiers d'habitation L19. On y trouvera les dropboxes pour les missions de livraison.</p>

    </div>
    <div class="info_generale">
        <h2>Portes de la ville</h2>
        <p>Les portes de la ville font le lien entre la surface de la planète Hurston et Lorville. Elles relient les faubourgs avec le centre actif. Vous pourrez y retirer vos véhicules terrestres via les garages et partir en exploration de la planète, ou bien simplement venir y déposer vos livraisons via les dropboxes présentes aux 6 portes. Vous pourrez d'ailleurs vous poser à la surface d'Hurston non-loin des portes pour effectuer les livraisons, et ainsi vous éviter les joies du transit intra-Lorville.</p>
        <li>Les portes 1, 2 et 3 sont situées à l'Est de Lorville</li>
    ...
    <div class="info_generale">
        <h2>Personnages d'intérêt</h2>
        <p>Dans le patch 3.6, il existe deux PNJ ayant la capacité de distribuer des missions. Au moins un autre sera ajouté par la suite.</p>
        <li>Clovus Darneely est le patron du Reclamation&Disposal de Lorville. Il faudra s'adresser à lui afin d'obtenir les missions de boîtes noires.</li>
        <li>Constantine Hurston, est à l'évidence membre de la prestigieuse famille du même nom. On pourra deviner de part les objets sur son bureau, qu'il est également membre du Million Mile High Club. Il donnera également certaines missions.</li>
    ...
    <div class="info_generale">
        ...
        <p>Biens disponible à l'achat:</p>
        <li>Scrap</li>
        <li>Waste</li>


        <p>Biens vendables à Lorville:</p>
        <li>Altruciatoxin</li>
        <li>Aluminium</li>
    ...
    <div class="info_generale">
        <h2>Leavsden Square</h2>
        <p>Leavsden est le centre d'activité de Lorville. Vous y trouverez de nombreux magasins, allant du simple magasin de vêtements aux revendeurs de puissantes machines à tuer. Un habitant de Lorville se lèvera au sein des résidences L19: les chambres personnelles des joueurs à Lorville sont remplies d'objets divers que nous vous encourageons à explorer, l'ambiance de travail quotidien y est plus que perceptible et ces chambres seront sans aucun doute sujettes à la personnalisation dans le futur. Leavsden possède sa propre station de métro ralliant central business district et est également accessible à pied depuis Metro center. On trouvera à Leavsden, un Tammany and sons, un bar MacIntyre & Victor's, le Reclamation&Disposal de Clovus et l’hôpital Maria Pure of Heart. Si ces deux derniers ont une place physique dans le jeu, leur gameplay n'est actuellement pas implémenté.</p>
        <div class="gallery_ville">
            <img src="img/ville33.jpg" alt="ville Lorville">
            <img src="img/ville34.jpg" alt="ville Lorville">
            <img src="img/ville35.jpg" alt="ville Lorville">
            <img src="img/ville36.jpg" alt="ville Lorville">
        </div>
    </div>
</section>