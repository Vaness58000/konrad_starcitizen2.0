...
-- Généré le : dim. 12 mars 2023 à 06:36
...
--
CREATE DATABASE IF NOT EXISTS `citizen` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `citizen`;
...
CREATE TABLE `arm_fps` (
  ...
  `portee` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `arm_fps` (`id`, `poids`, `portee`, `perte`, `id_arm`, `id_cat`) VALUES
(1, '50', '50', '50', 1, 1),
(2, '', '', '', 2, 1),
(3, '', '', '', 3, 1),
(4, '', '', '', 4, 1),
...
--
-- Déchargement des données de la table `arm_lieu`
--

INSERT INTO `arm_lieu` (`id`, `id_lieu`, `id_arm`, `prix`) VALUES
(1, 13, 1, '20'),
(2, 13, 13, '50');
...
--
-- Déchargement des données de la table `arm_vaiss`
--

INSERT INTO `arm_vaiss` (`id`, `id_arm`, `id_taille`) VALUES
(2, 13, 1);
...
INSERT INTO `avatar` (`id_avatar`, `id_user`, `nom`, `src`, `alt`, `date`) VALUES
(2, 2, 'avatar.png', 'avatar.png', 'avatar.png', '2023-02-27 12:18:58');
...
INSERT INTO `categories_articles` (`id_categorie_article`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'article', 2, '2023-03-02 07:41:41'),
(2, 'actualité', 2, '2023-03-02 07:41:41'),
(3, 'patch_note', 2, '2023-03-02 07:41:41');
...
CREATE TABLE `categories_especes` (
  ...
  `nom` varchar(155) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `img_cat` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `id_user_cat` int(10) NOT NULL,
  `date_cat` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `categories_especes`
--

INSERT INTO `categories_especes` (`id_categ_espece`, `nom`, `img_cat`, `id_user_cat`, `date_cat`) VALUES
(1, 'humain', 'civil1.jpg', 2, '2023-03-02 07:44:46');
...
INSERT INTO `categories_lieux` (`id_categ_lieu`, `nom`, `img_cat`, `id_user_cat`, `date_cat`) VALUES
(1, 'Planètes', '', 2, '2023-03-02 09:54:33'),
(2, 'Systèmes', '', 2, '2023-03-02 09:54:33'),
(3, 'Bestiaire', '', 2, '2023-03-02 09:54:33'),
(4, 'Lunes', '', 2, '2023-03-02 09:54:33'),
(5, 'Villes', '', 2, '2023-03-02 09:54:33'),
(6, 'Stations spatiales', '', 2, '2023-03-02 09:54:33'),
(7, 'Lieux insolites', '', 2, '2023-03-02 09:54:33');
...
INSERT INTO `categorie_arm_fps` (`id_categ_arme`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'pistolet', 2, '2023-03-02 07:57:22'),
(2, 'mitrailleur', 2, '2023-03-02 07:57:22'),
(3, 'fusil', 2, '2023-03-02 07:57:22'),
(4, 'sniper', 2, '2023-03-02 07:57:22');
...
--
-- Déchargement des données de la table `categorie_matiere_premier`
--

INSERT INTO `categorie_matiere_premier` (`id`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'fer', 2, '2023-03-02 09:57:04');
...
INSERT INTO `categorie_transport` (`id_transport`, `nom`, `img_cat`, `id_user_cat`, `date_cat`) VALUES
(1, 'vaisseau', '', 2, '2023-03-02 10:03:48'),
(2, 'vehicule', '', 2, '2023-03-02 10:03:48');
...
INSERT INTO `constructeur` (`id_constructeur`, `nom`, `logo`, `image`, `contenu`, `id_user`, `validation`) VALUES
...
--
-- Déchargement des données de la table `constructeur_lieu`
--

INSERT INTO `constructeur_lieu` (`id`, `id_constructeur`, `id_lieu`) VALUES
(1, 1, 13);
...
--
-- Déchargement des données de la table `construct_arm`
--

INSERT INTO `construct_arm` (`id`, `id_construct`, `id_arm`) VALUES
(1, 1, 1),
(2, 2, 13);
...
--
-- Déchargement des données de la table `controle_lieu`
--

INSERT INTO `controle_lieu` (`id`, `id_espece`, `id_lieu`) VALUES
(1, 1, 13);
...
INSERT INTO `couleur` (`id`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'bleu', 2, '2023-03-02 08:02:01'),
(2, 'gris', 2, '2023-03-02 08:02:01');
...
--
-- Déchargement des données de la table `couleur_lieu_arm`
--

INSERT INTO `couleur_lieu_arm` (`id`, `id_arm_lieu`, `id_couleur`) VALUES
(1, 2, 2),
(2, 1, 1);
...
--
-- Déchargement des données de la table `diplomatie`
--

INSERT INTO `diplomatie` (`id`, `type`, `traite`) VALUES
(1, 'diplomat1', 'diplomat1');
...
--
-- Déchargement des données de la table `diplomatie_espece`
--

INSERT INTO `diplomatie_espece` (`id`, `id_diplomatie`, `id_espece`) VALUES
(1, 1, 1);
...
INSERT INTO `disponibilite` (`id_disponibilite`, `nom_disponible`, `id_user_cat`, `date_cat`) VALUES
(1, 'disponibilite', 2, '2023-03-02 08:03:44');
...
INSERT INTO `equipement` (`id`, `nom`, `description`, `prix`) VALUES
(1, 'equipement1', 'test', '15'),
(4, 'kkk', 'dfdsgsgsgsssdsdgfdg', 'sgsfg'),
(5, 'cxc', '', 'xc'),
(6, 'cxc', '', 'xc'),
(7, 'cxc', '', 'xc'),
(8, 'cxc', 'xxxxxx', 'xc'),
...
(1, 30, '54,60€ seul (taxes comprises, prix constaté en Alpha)', 'monoplace', 'Petit (15m x 10m x 4m)', '48 tonnes', '1000 m/s', '2 SCU', '', 1, 1, 'lien_1', 1),
(2, 31, '65,52 € / 60.06 € warbond', 'Monospace', 'Petit (15m x 10m x 4m)', '48 tonnes', '1150 m/s', '2 SCU', '', 1, 1, 'lien_1', 1),
(3, 32, '72 dollars', 'Monoplace', 'Petit (15m x 10m x 4m)', '48 tonnes', '1095 m/s', '6 SCU', '', 1, 1, 'lien_1', 1),
(4, 33, '60 euros', 'Monospace', 'Petit (27m x 17m x 8m)', '66 tonnes', '1188 m/s', '8 SCU', '', 1, 1, 'lien_1', 1),
(5, 34, '71 euros', 'Monospace', 'Petit (27m x 17m x 8m)', '69 tonnes', '1223 m/s', '12 SCU', '', 1, 1, 'lien_1', 1),
(6, 35, '76 euros', 'Monospace', 'Petit (27m x 17m x 8m)', '72.5 tonnes', '1235 m/s', '4 SCU', '', 1, 1, 'lien_1', 1),
(7, 36, '112 euros', 'Monospace', 'Petit (27m x 17m x 8m)', '58 tonnes', '1.347 m/s', '4 SCU', '', 1, 1, 'lien_1', 1),
(8, 37, '273 euros', 'Le vaisseau est conçu pour 3 personnes.', 'Moyen (60m x 32m x 12.5m)', '430 tonnes', '? m/s', '42 SCU', '', 1, 1, 'lien_1', 1),
(9, 38, '427 euros', 'Le vaisseau est conçu pour 5 membres d\'équipage', 'Grand (91m x 52m x 17m)', '1577 tonnes', '955 m/s', '40 SCU', '', 1, 1, 'lien_1', 1),
(10, 39, '470 euros', '5 membres d\'équipage + 4 passagers', 'Grand (91m x 52m x 17m)', '1576 tonnes', '955 m/s', '16 SCU', '', 1, 1, 'lien_1', 1),
(11, 40, '55 euros', 'Le vaisseau a deux postes de travail', 'Petit (13m x 10m x 2m)', '19 tonnes', '1183 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(12, 41, '967 euros', '', 'Capital (207m x 74m x 40m)', '4.590 tonnes', '900 m/s', '480 SCU', '', 1, 1, 'lien_1', 1),
(13, 42, '300 euros', 'Le vaisseau est conçu pour un équipage à deux', 'Moyen (43m x 30m x 10m)', '376 tonnes', '? m/s', '28 SCU', '', 1, 1, 'lien_1', 1),
(14, 43, '300 dollars', 'Le vaisseau est conçu pour un équipage à deux', 'Moyen (43m x 30m x 10m)', '376 tonnes', '? m/s', '28 SCU', '', 1, 1, 'lien_1', 1),
(15, 44, '240 euros', 'Monospace', 'Moyen (27.2m x 30.2m x 5.5m)', '? tonnes', '? m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(16, 45, '240 euros', 'Monospace', 'Moyen (27.2m x 30.2m x 5.5m)', '? tonnes', '? m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(17, 46, '98 euros avec un pack de départ ou\r\n82 euros seul (il faut un pack pour pouvoir jouer)\r\n', 'Monospace', 'Petit (16m x 12m x 4m)', '30 tonnes', '1235 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(18, 47, '49 euros (il faut un pack pour pouvoir jouer)', 'Monospace', 'Petit (18m x 8m x 4m)', '25 tonnes', '1093 m/s', '6 SCU', '', 1, 1, 'lien_1', 1),
(19, 48, '22 euros seul (il faut un pack pour pouvoir jouer)', 'Monospace', 'Petit (18m x 8m x 4m)', '25 tonnes', '1141 m/s', '3 SCU', '', 1, 1, 'lien_1', 1),
(20, 49, '38 euros seul (il faut un pack pour pouvoir jouer)', 'Monospace', 'Petit (18m x 8m x 4m)', '25 tonnes', '1209 m/s', '3 SCU', '', 1, 1, 'lien_1', 1),
(21, 50, 'Environ 36 euros seul (il faut un pack pour pouvoir jouer)', 'Monospace', 'Petit (18m x 8m x 4m)', '25 tonnes', '1199 m/s', '3 SCU', '', 1, 1, 'lien_1', 1),
(22, 51, '49 euros avec un pack de départ\r\n\r\n27 euros seul (il faut un pack pour pouvoir jouer)', 'Monospace', 'Petit (18m x 8m x 4m)', '25 tonnes', '1212 m/s', '3 SCU', '', 1, 1, 'lien_1', 1),
(23, 52, '82 euros avec un pack de départ\r\n\r\n65 euros seul (il faut un pack pour pouvoir jouer)', 'C\'est un vaisseau monoplace, avec une seule couchette', 'Petit (22.5m x 16.5m x 23.5m)', '50 tonnes', '1310 m/s', '0-8 SCU', '', 1, 1, 'lien_1', 1),
(24, 53, '60 dollars', 'Monospace avec une seule couchette', 'Petit (22.5m x 16.5m x 5.5m)\r\n\r\n', '50 tonnes', '1115 m/s', '8 SCU', '', 1, 1, 'lien_1', 1),
(25, 54, '90 dollars seul', 'Monoplace', 'Petit (22.5m x 16.5m x 5.5m)', '50 tonnes', '1310 m/s', '8 SCU', '', 1, 1, 'lien_1', 1),
(26, 55, '102 dollars seul ', 'Monoplace', 'Petit (22.5m x 16.5m x 23.5m)', '50 tonnes', '1305 m/s', '0-8 SCU', '', 1, 1, 'lien_1', 1),
(27, 56, '131 euros seul', '2, un pilote et un tireur', 'Véhicule (17m x 7m x 5.5m)', '? tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(28, 57, '342 dollars seul', 'Monoplace', 'Petit (15.5m x 20m x 4.5m)', '26 tonnes', '1240 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(29, 58, '132 dollars seul ', 'Monoplace', 'Petit (15m x 16m x 4.6m)', '40 tonnes', '1315 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(30, 59, 'Livré avec le Carrack', 'Le vaisseau dispose de 3 places.', 'Petit (12m x 10.3m x 3.3m)', '? tonnes', '1150 m/s', '4 SCU', '', 1, 1, 'lien_1', 1),
(31, 60, '49 euros seul ', 'Le vaisseau dispose de 3 places.', 'Petit (12m x 10.3m x 3.3m)', '? tonnes', '1150 m/s', '4 SCU', '', 1, 1, 'lien_1', 1),
(32, 61, '546 €', 'Le vaisseau est conçu pour 6 membres d\'équipage', 'Grand (126.5m x 76.5m x 30m)', '4.397 tonnes', '1236 m/s', '456 SCU', '', 1, 1, 'lien_1', 1),
(33, 62, '354 dollars seul ', 'Le vaisseau dispose de 4 lits', 'Grand (111.5m x 39m x 13.5m)', '1.608 tonnes', '890 m/s', '576 SCU', '', 1, 1, 'lien_1', 1),
(34, 63, '300 euros avec un pack de départ\r\n\r\n245 euros seul ', 'Quatre lits.\r\n\r\nUn tireur dans chaque tourelle.\r\n\r\nUn pilote dans le vaisseau parasite.', 'Grand (61m x 26m x 14m)', '419 tonnes', '910 m/s', '96 SCU', '', 1, 1, 'lien_1', 1),
(35, 64, '338 euros seul (il faut un pack pour pouvoir jouer)\r\n(taxes comprises, prix constaté en Alpha)', 'Quatre lits.\r\n\r\nUn tireur dans chaque tourelle.\r\n\r\nUn pilote dans le vaisseau parasite.', 'Grand (61m x 26m x 14m)', '439 tonnes', '987 m/s', '96 SCU', '', 1, 1, 'lien_1', 1),
(36, 65, '420 dollars seul (il faut un pack pour pouvoir jouer)', '	\r\nHuit lits.\r\n\r\nUn tireur dans chaque tourelle.\r\n\r\nUn pilote dans le vaisseau parasite.', 'Grand (61m x 26m x 14m)', '274 tonnes', '910 m/s', '80 SCU', '', 1, 1, 'lien_1', 1),
(37, 66, '164 euros seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 4 lits.', '164 euros seul (taxes comprises, prix constaté en Alpha)', '416 tonnes', '? m/s', '? SCU', '', 1, 1, 'lien_1', 1),
(38, 67, '212 euros seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est conçu pour 4 personnes', 'Moyen (55m x 27m x 31m)', '? tonnes', '? m/s', '72 SCU', '', 1, 1, 'lien_1', 1),
(39, 68, '420 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est prévu pour 8 membres d\'équipage', 'Grand (90m x 50m x 20m)', '3.650 tonnes', '? m/s', '230 SCU', '', 1, 1, 'lien_1', 1),
(40, 69, '120 dollars (taxes comprises, prix constaté en Alpha)', 'Un pilote et un tireur dans la tourelle.', 'Moyen (29m x 26.5m x 10m)', '227 tonnes', '1115 m/s', '46 SCU', '', 1, 1, 'lien_1', 1),
(41, 70, '180 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et un opérateur tourelle', 'Moyen (29m x 26.5m x 10m)', '227 tonnes', '? m/s', '25 SCU', '', 1, 1, 'lien_1', 1),
(42, 71, '131 euros seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est conçu pour deux personnes', 'Moyen (36m x 26m x 10m)', '227 tonnes', '? m/s', '12 SCU', '', 1, 1, 'lien_1', 1),
(43, 72, '60 euros seul (taxes comprises, prix constaté en Alpha)', 'Le véhicules possède deux places', 'Véhicule (6m x 4m x 3m)', '3 tonnes', '? m/s', '1 SCU', '', 2, 2, 'lien_1', 1),
(44, 73, '96 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le véhicules possède deux places', 'Véhicule (6m x 4m x 3m)', '3 tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(45, 74, '81.90 € / 70.98 € warbond', '1 - 3 Membres', 'Vehicule (6.0m x 4.0m x 2.5m)', '3 Tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(46, 75, '71 euros seul (taxes comprises, prix constaté en Alpha)', 'C\'est un véhicule biplace', 'Petit (6m x 4m x 3m)', '3 tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(47, 76, '78 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le véhicules possède deux places', 'Véhicule (6m x 4m x 3m)', '3 tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(48, 77, '78 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le véhicule comporte trois places', 'Véhicule (6m x 4m x 3m)', '3 tonnes', '0 m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(49, 78, '222 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un biplace', 'Petit (33.5m x 13.2m x 4m)', '78 tonnes', '? m/s', '0 SCU', '', 2, 2, 'lien_1', 1),
(50, 79, '48 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et un passager', 'Parasite (6m x 3.5m x 1.5m)', '2 tonnes', '1.100 m/s', '0 - 1 SCU', '', 2, 2, 'lien_1', 1),
(51, 80, '48 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et un passager', 'Parasite (6m x 3.5m x 1.5m)', '2 tonnes', '1.100 m/s', '0 - 1 SCU', '', 2, 2, 'lien_1', 1),
(52, 81, '360 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un vaisseau monoplace', 'Moyen (20.5m x 36.6m x 4.4m)', '52 tonnes', '980 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(53, 82, '420 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est prévu pour 5 personnes', '?', '4.000 tonnes', '? m/s', '500 SCU', '', 1, 1, 'lien_1', 1),
(54, 83, '136 euros avec un pack de départ.\r\n\r\n120 euros seul (il faut un pack pour pouvoir jouer).', 'C\'est un mono place', 'Petit (22.5m x 21.5m x 6.5m)', '73 tonnes', '1225 m/s', '2 SCU', '', 1, 1, 'lien_1', 1),
(55, 84, '210 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un mono place', 'Petit (22.5m x 21.5m x 6.5m)', '73 tonnes', '1225 m/s', '0-2 SCU', '', 1, 1, 'lien_1', 1),
(56, 85, '191 euros seul (il faut un pack pour pouvoir jouer)\r\n', 'C\'est un biplace', 'Petit (25.5m x 24m x 6.5m)', '78 tonnes', '1222 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(57, 86, 'Environ 216 dollars seul (il faut un pack pour pouvoir jouer)', 'C\'est un biplace', 'Petit (25.5m x 24m x 6.5m)', '78 tonnes', '1222 m/s', '0 à 2 SCU', '', 1, 1, 'lien_1', 1),
(58, 87, '153 euros seul (taxes comprises, prix constaté en Alpha)', 'C\'est un mono place', 'Petit (22.5m x 21.5m x 6.5m)', '73 tonnes', '1.215 m/s', '0-2 SCU', '', 1, 1, 'lien_1', 1),
(59, 88, '136 euros seul (taxes comprises, prix constaté en Alpha)', 'C\'est un mono place', 'Petit (22.5m x 21.5m x 6.5m)', '73 tonnes', '1.225 m/s', '0-2 SCU', '', 1, 1, 'lien_1', 1),
(60, 89, '136 euros avec un pack de départ.\r\n\r\n120 euros seul\r\n(taxes comprises, prix constaté en Alpha).', 'Le vaisseau dispose de 4 lits - \r\nUn pilote et un tireur en tourelle', 'Moyen (38m x 23.5m x 9.5m)', '209 tonnes', '1005 m/s', '1005 m/s', '', 1, 1, 'lien_1', 1),
(61, 90, '162 dollars seul (il faut un pack pour pouvoir jouer)\r\n(taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 4 lits', 'Moyen (38m x 23.5m x 9.5m)', '213 tonnes', '1100 m/s', '36 SCU', '', 1, 1, 'lien_1', 1),
(62, 91, '180 dollars seul (il faut un pack pour pouvoir jouer)\r\n(taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 4 lits', 'Moyen (38m x 36m x 9.5m)', '336 tonnes', '1005 m/s', '120 SCU', '', 1, 1, 'lien_1', 1),
(63, 92, '210 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 4 lits', 'Moyen (38m x 23.5m x 9.5m)', '213 tonnes', '1.035 m/s', '36 SCU', '', 1, 1, 'lien_1', 1),
(64, 93, '480 dollars seul (taxes comprises, prix constaté en Alpha)', '8 membres d\'équipage pour accueillir les 40 passagers', 'Grand (85m x 90m x 16m)', '? tonnes', '? m/s', '300 SCU', '', 1, 1, 'lien_1', 1),
(65, 94, '198 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et un opérateur tourelle', 'Petit (22.5m x 22.5m x 6m)', '87 tonnes', '980 m/s', '980 m/s', '', 1, 1, 'lien_1', 1),
(66, 95, '98 euros seul (taxes comprises, prix constaté en Alpha)', 'C\'est un vaisseau monoplace', 'Petit (20m x 17m x 5.5m)', '49 tonnes', '1235 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(67, 96, '382 euros seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Moyen (31m x 31.5m x 8.5m)', '66 tonnes', '1.229 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(68, 97, '870 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 9 lits. Pilote + les 6 tourelles actives', 'Grand (115m x 75m x 16m)', '4.260 tonnes', '915 m/s', '40 SCU', '', 1, 1, 'lien_1', 1),
(69, 98, '120 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Petit (16m x 13m x 4m)', '40 tonnes', '1.235 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(70, 99, '102 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Petit (23.5m x 12.5m x 9m)', '66 tonnes', '1.360 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(71, 100, '840 dollars seul (taxes comprises, prix constaté en Alpha)', '\r\nLe vaisseau est conçu pour un équipage à 8', 'Grand (94m x 70m x 23m)', '? tonnes', '? m/s', '234 SCU', '', 1, 1, 'lien_1', 1),
(72, 101, '432 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et deux opérateurs tourelles', 'Grand (94m x 70m x 23m)', '? tonnes', '? m/s', '624 SCU', '', 1, 1, 'lien_1', 1),
(73, 102, '576 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le pilote et les 3 opérateurs des tourelles', 'Grand (94m x 70m x 23m)', '? tonnes', '? m/s', '468 SCU', '', 1, 1, 'lien_1', 1),
(74, 103, '72 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un vaisseau monoplace', 'Petit (22m x 8m x 4m)', '122 tonnes', '? m/s', '48 SCU', '', 1, 1, 'lien_1', 1),
(75, 104, '108 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Moyen (48m x 15.5m x 17m)', '387 tonnes', '? m/s', '384 SCU', '', 1, 1, 'lien_1', 1),
...
(77, 106, '385 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau peut accueillir 5 personnes', 'Capital (209m x 70m x 70m)', '1.216 tonnes', '? m/s', '20736 SCU', '', 1, 1, 'lien_1', 1),
(78, 107, '780 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau peut accueillir 5 personnes', 'Capital (372m x 104m x 104m)', '1.652 tonnes', '? m/s', '98304 SCU', '', 1, 1, 'lien_1', 1),
...
(81, 110, '1800 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est conçu pour 28 membres d\'équipage', 'Capital (242m x 126m x 46m)', '37.310 tonnes', '? m/s', '995 SCU', '', 1, 1, 'lien_1', 1),
(82, 111, '3600 dollars seul (taxes comprises, prix constaté en Alpha)', '80 membres d\'équipage sont prévus', 'Capital (480m x 198m x 72m)', '109.900 tonnes', '? m/s', '5.400 SCU', '', 1, 1, 'lien_1', 1),
...
(85, 114, '2400 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est prévu pour 10 membres\r\nd\'équipage et 10 commerçants', 'Capital (270m x 104m x 64m)', '? tonnes', '? m/s', '768 + 10 x 189 SCU', '', 1, 1, 'lien_1', 1),
(86, 115, '628 euros seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et un opérateur tourelle', 'Grand (128m x 68m x 24m)', '? tonnes', '122 m/s', '400 SCU', '', 1, 1, 'lien_1', 1),
(87, 116, 'Origin Jumpworks GmbH', 'C\'est un vaisseau monoplace.', 'Petit (11m x 10m x 3m)', '10 tonnes', '1.345 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(88, 117, '164 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Petit (30m x 17m x 8m)', '? tonnes', '1307 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(89, 118, '420 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est conçu pour 8 membres d\'équipage', 'Grand (160m x 160m x 65m)', '9.600 tonnes', '? m/s', '3584 SCU', '', 1, 1, 'lien_1', 1),
(90, 119, '270 dollars seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau est conçu pour trois membres d\'équipage', 'Moyen (40m x 38m x 11.6m)', '? tonnes', '1050 m/s', '114 SCU', '', 1, 1, 'lien_1', 1),
(91, 120, '344 euros seul (taxes comprises, prix constaté en Alpha)', 'Pilote et poste de minage principal', 'Moyen (38.5m x 17m x 8m)', '?', '1090 m/s', '288 SCU', '', 1, 1, 'lien_1', 1),
(92, 121, '42 dollars seul (taxes comprises, prix constaté en Alpha)', 'C\'est un monoplace', 'Parasite (9.5m x 8.5m x 4.3m)', '12 tonnes', '900 m/s', '2 SCU', '', 1, 1, 'lien_1', 1),
(93, 122, '48 dollars seul (taxes comprises, prix constaté en Alpha)', 'Un pilote et 8 passagers', 'Parasite (9.5m x 8.5m x 4.3m)', '12 tonnes', '900 m/s', '0-2 SCU', '', 1, 1, 'lien_1', 1),
(94, 123, '49 euros avec un pack de départ.\r\n\r\n33 euros seul (il faut un pack pour pouvoir jouer).\r\n', 'C\'est un mono place', 'Petit (17.5m x 15.5m x 5.5m)', '17 tonnes', '1160 m/s', '6 SCU', '', 1, 1, 'lien_1', 1),
(95, 124, '44 euros seul (il faut un pack pour pouvoir jouer)', 'C\'est un mono place\r\n', 'Petit (17.5m x 15.5m x 5.5m)', '39 tonnes', '1215 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(96, 125, '', 'C\'est un mono place', 'Petit (17.5m x 15.5m x 5.5m)', '37 tonnes', '1225 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(97, 126, '60 euros seul (il faut un pack pour pouvoir jouer)\r\n(taxes comprises, prix constaté en Alpha)', 'C\'est un mono place', 'Petit (17.5m x 15.5m x 5.5m)', '30 tonnes', '1342 m/s', '0 SCU', '', 1, 1, 'lien_1', 1),
(98, 127, '791 euros seul (taxes comprises, prix constaté en Alpha)', 'Le vaisseau dispose de 8 lits', 'Grand (125m x 72m x 21m)', '13.500 tonnes', '? m/s', '? m/s', '', 1, 1, 'lien_1', 1),
(99, 128, '87 euros seul (taxes comprises, prix constaté en Alpha)', 'Vaisseau monoplace', 'Consolidated Outlands', '228 tonnes', '1171 m/s', '1171 m/s', '', 1, 1, 'lien_1', 1);
...
INSERT INTO `especes` (`id_espece`, `id_objet`, `id_categ_espece`, `gouvernence`, `souverainete`, `philosophie`, `religion`, `pre_contact`, `origine`) VALUES
(1, 129, 1, 'ee', 'rr', 'tt', 'yy', 'uu', 'ii');
...
--
-- Déchargement des données de la table `faiblesses`
--

INSERT INTO `faiblesses` (`id_faiblesse`, `nom_faiblesse`, `id_user_cat`, `date_cat`) VALUES
(1, 'faiblesse1', 2, '2023-03-02 09:49:01');
...
--
-- Déchargement des données de la table `forces`
--

INSERT INTO `forces` (`id_force`, `nom_force`, `id_user_cat`, `date_cat`) VALUES
(1, 'force1', 2, '2023-03-02 09:51:40');

-- --------------------------------------------------------

--
-- Structure de la table `gameplay_type`
--

CREATE TABLE `gameplay_type` (
  `id` int(10) NOT NULL,
...
--
-- Déchargement des données de la table `gameplay_type`
--

INSERT INTO `gameplay_type` (`id`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'pirate', 2, '2023-03-02 10:06:20'),
(7, 'vendeur', 9, '2023-03-09 14:57:06'),
(8, 'vaisseau', 9, '2023-03-09 14:57:15');

-- --------------------------------------------------------

--
-- Structure de la table `gameplay_type_articles`
--

CREATE TABLE `gameplay_type_articles` (
  `id` int(10) NOT NULL,
  `id_article` int(10) NOT NULL,
  `id_gameplay_type` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `gameplay_type_articles`
--

INSERT INTO `gameplay_type_articles` (`id`, `id_article`, `id_gameplay_type`) VALUES
(1, 3, 1);
...
(172, 'actus5.jpg', 'actus5.jpg', 'actus5.jpg', 132, 0),
(173, 'actus5.jpg', 'actus5.jpg', 'actus5.jpg', 131, 1),
(174, 'arme10.jpg', 'arme10.jpg', 'arme10.jpg', 130, 0),
(175, 'humain3.jpg', 'humain3.jpg', 'humain3.jpg', 129, 0),
(176, 'fer.jpg', 'fer.jpg', 'fer.jpg', 133, 0);
...
--
-- Déchargement des données de la table `lier_lieu`
--

INSERT INTO `lier_lieu` (`id`, `id_lieu`, `id_lieu_lier`) VALUES
(1, 1, 4);
...
INSERT INTO `lieux` (`id_lieu`, `id_objet`, `id_categ_lieu`, `Habitable`) VALUES
(1, 13, 1, 1),
(2, 14, 1, 1),
(3, 15, 1, 1),
(4, 16, 1, 1),
...
--
-- Déchargement des données de la table `lieux_risque`
--

INSERT INTO `lieux_risque` (`id`, `id_lieux`, `id_risque`) VALUES
(1, 1, 1);
...
--
-- Déchargement des données de la table `lieu_espece`
--

INSERT INTO `lieu_espece` (`id`, `id_lieu`, `id_espece`) VALUES
(1, 13, 1);
...
INSERT INTO `matiere_premiere` (`id`, `id_categorie`, `id_objet`) VALUES
(1, 1, 133);
...
(30, '100i', 'Il s\'agit de la version \"voyage\" de la gamme 100, une série de vaisseaux de démarrage haut de gamme, ayant la particularité d\'avoir de base un système de raffinage de gaz intégré leur conférant un grand rayon d\'action.', 9, 2, '2023-02-10 17:13:45', 1),
...
(129, 'humain', 'testing', 9, 4, '2023-02-21 08:52:30', 1),
(130, 'arm vaiss', 'arm vaiss', 9, 1, '2023-02-21 09:03:27', 1),
(131, 'proprietaire', 'test', 9, 5, '2023-02-21 10:05:52', 1),
(132, 'service1', 'test', 9, 6, '2023-02-21 10:11:26', 1),
(133, 'matiere_premiere_1', 'matiere_premiere_1', 9, 7, '2023-02-27 22:20:58', 1);
...
CREATE TABLE `objet_type` (
  `id` int(10) NOT NULL,
  `nom` varchar(155) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `id_user_obj_type` int(10) NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `objet_type` (`id`, `nom`, `id_user_obj_type`, `date`) VALUES
...
(5, 'propriétaire', 2, '2023-02-21 09:58:16'),
(6, 'service', 2, '2023-02-21 09:58:16'),
(7, 'Matière première', 9, '2023-02-27 21:52:46');
...
--
-- Déchargement des données de la table `prod_pre_lieu`
--

INSERT INTO `prod_pre_lieu` (`id`, `id_prod_pre`, `id_lieu`, `prix_vente`, `prix_achat`, `actu_min`, `inv_max`) VALUES
(1, 1, 13, '25', '25', '111', '222');
...
INSERT INTO `proprietaire` (`id`, `logo`, `id_objet`) VALUES
(1, 'actus5.jpg', 131);
...
--
-- Déchargement des données de la table `proprietaire_lieu`
--

INSERT INTO `proprietaire_lieu` (`id`, `id_proprietaire`, `id_lieu`) VALUES
(1, 1, 13);
...
INSERT INTO `risque` (`id`, `nom`, `id_user_cat`, `date_cat`) VALUES
(1, 'aucun', 2, '2023-03-02 09:58:43');
...
INSERT INTO `screens` (`id_screen`, `id_user`, `name`, `image`, `alt`, `src`, `date`, `validation`) VALUES
(1, 9, '262f7041f0f5f688_1920xH.jpg', '262f7041f0f5f688_1920xH.jpg', '262f7041f0f5f688_1920xH.jpg', '262f7041f0f5f688_1920xH.jpg', '2023-02-10 17:13:44', 1),
(2, 8, '804504.jpg', '804504.jpg', '804504.jpg', '804504.jpg', '2023-02-10 17:13:44', 1),
(3, 8, 'ArcCorp.png', 'ArcCorp.png', 'ArcCorp.png', 'ArcCorp.png', '2023-02-10 17:13:44', 1),
(4, 8, 'gallerie.jpg', 'gallerie.jpg', 'gallerie.jpg', 'gallerie.jpg', '2023-02-10 17:13:44', 1),
(5, 8, 'gallerie3.jpg', 'gallerie3.jpg', 'gallerie3.jpg', 'gallerie3.jpg', '2023-02-10 17:13:44', 1),
(6, 8, 'gallerie4.jpg', 'gallerie4.jpg', 'gallerie4.jpg', 'gallerie4.jpg', '2023-02-10 17:13:44', 1),
(7, 8, 'gallerie5.jpg', 'gallerie5.jpg', 'gallerie5.jpg', 'gallerie5.jpg', '2023-02-10 17:13:44', 1),
(8, 8, 'gallerie6.jpg', 'gallerie6.jpg', 'gallerie6.jpg', 'gallerie6.jpg', '2023-02-10 17:13:44', 1),
(9, 8, 'gallerie7.jpg', 'gallerie7.jpg', 'gallerie7.jpg', 'gallerie7.jpg', '2023-02-10 17:13:44', 1),
(10, 8, 'gallerie8.jpg', 'gallerie8.jpg', 'gallerie8.jpg', 'gallerie8.jpg', '2023-02-10 17:13:44', 1),
(11, 8, 'gallerie9.jpg', 'gallerie9.jpg', 'gallerie9.jpg', 'gallerie9.jpg', '2023-02-10 17:13:44', 1),
(12, 8, 'gallerie10.jpg', 'gallerie10.jpg', 'gallerie10.jpg', 'gallerie10.jpg', '2023-02-10 17:13:44', 1),
(13, 8, 'gallerie11.jpg', 'gallerie11.jpg', 'gallerie11.jpg', 'gallerie11.jpg', '2023-02-10 17:13:44', 1),
(14, 8, 'gallerie12.jpg', 'gallerie12.jpg', 'gallerie12.jpg', 'gallerie12.jpg', '2023-02-10 17:13:44', 1),
(15, 8, 'station4.jpg', 'station4.jpg', 'station4.jpg', 'station4.jpg', '2023-02-10 17:13:44', 1),
(16, 8, 'ville7.png', 'ville7.png', 'ville7.png', 'ville7.png', '2023-02-10 17:13:44', 1),
(17, 7, 'lune25.jpg', 'lune25.jpg', 'lune25.jpg', 'lune25.jpg', '2023-02-10 17:13:44', 1),
(18, 7, 'vaisseau26.jpg', 'vaisseau26.jpg', 'vaisseau26.jpg', 'vaisseau26.jpg', '2023-02-10 17:13:44', 1),
(19, 7, 'vaisseau67.jpg', 'vaisseau67.jpg', 'vaisseau67.jpg', 'vaisseau67.jpg', '2023-02-10 17:13:44', 1),
(20, 7, 'wallpaperflare.com_wallpaper (26).jpg', 'wallpaperflare.com_wallpaper (26).jpg', 'wallpaperflare.com_wallpaper (26).jpg', 'wallpaperflare.com_wallpaper (26).jpg', '2023-02-10 17:13:44', 1),
(21, 7, 'vanduul10.jpg', 'vanduul10.jpg', 'vanduul10.jpg', 'vanduul10.jpg', '2023-02-10 17:13:44', 1),
(22, 7, 'actus2.jpg', 'actus2.jpg', 'actus2.jpg', 'actus2.jpg', '2023-02-10 17:13:44', 1);
...
INSERT INTO `service` (`id`, `id_objet`) VALUES
(1, 132);
...
--
-- Déchargement des données de la table `service_lieu`
--

INSERT INTO `service_lieu` (`id`, `id_service`, `id_lieu`) VALUES
(1, 1, 13);
...
--
-- Déchargement des données de la table `taille_arm_vaisseau`
--

INSERT INTO `taille_arm_vaisseau` (`id`, `taille`, `id_user_cat`, `date_cat`) VALUES
(1, '1', 2, '2023-03-02 10:01:18');
...
CREATE TABLE `transport_arm` (
  `id` int(10) NOT NULL,
  `id_transport` int(10) NOT NULL,
  `id_arm_transp` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `transport_arm`
--

INSERT INTO `transport_arm` (`id`, `id_transport`, `id_arm_transp`) VALUES
(1, 1, 2);
...
--
-- Déchargement des données de la table `transport_lieu`
--

INSERT INTO `transport_lieu` (`id`, `id_transport`, `id_lieu`) VALUES
(1, 1, 13);
...
--
-- Déchargement des données de la table `transp_equip`
--

INSERT INTO `transp_equip` (`id`, `id_equip`, `id_transp`) VALUES
(1, 1, 1);
...
--
-- Déchargement des données de la table `transp_faiblesses`
--

INSERT INTO `transp_faiblesses` (`id`, `id_faiblesse`, `id_transp`) VALUES
(1, 1, 1);
...
--
-- Déchargement des données de la table `transp_forces`
--

INSERT INTO `transp_forces` (`id`, `id_transp`, `id_forces`) VALUES
(1, 1, 1);
...
INSERT INTO `utilisateurs` (`id_user`, `pseudo`, `email`, `password`, `ip`, `token`, `date_inscription`, `id_role`, `id_type`) VALUES
(1, 'vanessa', 'vanessa.geoffroid@gmail.com', '$2y$12$T2Tjgzylp2pjyAdqzh3keuTyE53488HYwg3rtmmyP46k2Zy8mKmXy', '127.0.0.1', '1d62c413a75f7f64bfc4821aaba5ad3530e3e54a62ce5670f4e1daff795e4de5e461676928ec26d3d7e6cfef60eaceb76879162d1f441eb06153ea57f362a1ac', '2023-01-07 23:59:01', 2, 1),
(2, 'konrad', 'vaness.geo@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$bHZoMGdiWFA5SHBzeXVxOQ$buf+Emm3i/3DYNflwRFB9hKlXbPHIAyi1YHycF2Nt40', '127.0.0.1', 'd8c0f95e977d05cdcca3042388f6b1e1395c2710f442fedc438acc6b96c09ba722469b3cdd265b75f8430b823026140542de1635e4241f8448aac53ff9296dbf', '2023-01-08 00:05:33', 2, 2),
(3, 'geoffroid', 'va@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$dE5wbWM0Nlk0YkRNR211OQ$01GMuVnrSxBHnukoe23Om/KQHpTwWfrgtlSZCP3aM3g', '127.0.0.1', 'e058c8fe609740c2cd8d55e1fffb529950d2efb9bd10a708cc8ba166e150ceaccb92d085ba2c506338370661d6971f3baa3177fb1d58bca438899d22d9773528', '2023-01-08 00:21:15', 2, 1),
(4, 'gdgdg', 'gegeg@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$QkdKLzNZaldBQm5MalZpMQ$v8PG2flft/47zKlpVfGfyIcL5PlSHOORGHkUDfZ4VfA', '127.0.0.1', '5abb1b6b612e7f580fad5b47dbc630c618b2aa736c21a40d6dd1e95f866f7d0439a79fe8bbaa85d598e6c8ff4edb66224e3ef4f921bed79f1a27d620463b69c7', '2023-01-08 00:22:32', 2, 1),
(5, 'Konrad1', 'hfejhefheuj@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$b0h5dEFSbVU2cmdwdGFISQ$2iorFUQOd6iaivOyGtlRFKpDc5hBNZuo7HYrsCGrN+s', '127.0.0.1', '7f79a869abbccd80ba8ae416d42ca0ba3ee4c2a145c4a4827bc2e46d02cfca1643fbb5b6a55eb4d69552cc5bfb5e76f74c95c41fd2d4ee3199feb1b5baf6c311', '2023-01-08 00:24:06', 2, 1),
(6, 'VAN', 'vane@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$V1ZJWEE4WEhxNzlHMzRINQ$nfEhewPRWvNxcSGhEM33E7Zm6zN/7gmMxtUR7DFInnI', '127.0.0.1', 'fe158f4aab8b2cd709e1ac7a856a05b5bb9db4731b193f3ad4917c753672d40162d5b2cc442cb45a3cb4195c544513e58841c341ffc31222a4e289c04fb899b4', '2023-01-08 00:26:21', 2, 1),
(7, 'Poukette', 'vanessa@gmail.com', '$2y$12$tZtFIsTXovFAcxiAuu1n4eyyKHYISN4vJLZxqXURkiqR.HHSOslcm', '::1', '1ac42a4e92bce593bd9e4e553185de30bda0d0f0e9baa9a9564bc59071736192815756276499ad92a5ee8f1a7a2952b2c92c9c82e15af9c8d18e71f4b39a0d70', '2023-01-28 15:38:55', 1, 1),
(8, 'pouk', 'poukette@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$aml0ajJaNWZRb3dkeHB1YQ$WuR3UZcCtIA/BZZ8euTTfziwZt64ONhriYBWC6UIrZg', '127.0.0.1', '0ec3800c5664a9cb72f1da62419b3fb846f21203d5f0435dfbfbea51c84056759fec3c986174df05c82f2bf36340aede351864a99a7e02c2a2c80f21cbc1f1bc', '2023-01-30 11:22:22', 2, 1),
(9, 'root', 'root@free.fr', '$argon2i$v=19$m=65536,t=4,p=1$U2laOGNRNWJoTlZBYU9kZw$EykOpVSxtuWQ5Qs2Fs/bVD6+3auyCogZXHI7H5X+aQA', '172.29.0.1', 'fbb3eace544498ab8a2a55fa12a9300505119d3d54040971e20c60ca7d567e4becd1096f6c0d7a78fd90db73a6ff103d28f406bb8900982c6e2ddf5057ee221d', '2023-02-10 17:57:46', 2, 1);
...
ALTER TABLE `categories_articles`
  ...
  ADD KEY `id_cat_article_user` (`id_user_cat`);
...
ALTER TABLE `categories_especes`
  ...
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_espece_user` (`id_user_cat`);
...
ALTER TABLE `categories_lieux`
  ...
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_lieu_user` (`id_user_cat`);
...
ALTER TABLE `categorie_arm_fps`
  ...
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_arm_user` (`id_user_cat`);
...
ALTER TABLE `categorie_matiere_premier`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_mat_pre_user` (`id_user_cat`);
...
ALTER TABLE `categorie_transport`
  ...
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_transp_user` (`id_user_cat`);
...
ALTER TABLE `couleur`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_couleur_user` (`id_user_cat`);
...
ALTER TABLE `disponibilite`
  ...
  ADD KEY `id_cat_disponib_user` (`id_user_cat`);
...
ALTER TABLE `faiblesses`
  ...
  ADD KEY `id_cat_faibl_user` (`id_user_cat`);
...
ALTER TABLE `forces`
  ...
  ADD KEY `id_cat_force_user` (`id_user_cat`);

--
-- Index pour la table `gameplay_type`
--
ALTER TABLE `gameplay_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_type_article_user` (`id_user_cat`);

--
-- Index pour la table `gameplay_type_articles`
--
ALTER TABLE `gameplay_type_articles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_gameplay_type_article` (`id_article`),
  ADD KEY `id_gameplay_type_type` (`id_gameplay_type`);
...
ALTER TABLE `objet_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_obj_type_user` (`id_user_obj_type`);
...
ALTER TABLE `risque`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`),
  ADD KEY `id_cat_risque_user` (`id_user_cat`);
...
ALTER TABLE `taille_arm_vaisseau`
  ...
  ADD KEY `id_cat_taill_user` (`id_user_cat`);
...
ALTER TABLE `transport_arm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_transp_arm_arm` (`id_arm_transp`),
...
--
ALTER TABLE `categories_articles`
  MODIFY `id_categorie_article` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `categories_especes`
--
ALTER TABLE `categories_especes`
  MODIFY `id_categ_espece` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT pour la table `categories_lieux`
--
ALTER TABLE `categories_lieux`
  MODIFY `id_categ_lieu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `categorie_arm_fps`
--
ALTER TABLE `categorie_arm_fps`
  MODIFY `id_categ_arme` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `categorie_transport`
  MODIFY `id_transport` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `constructeur`
--
ALTER TABLE `constructeur`
  MODIFY `id_constructeur` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `disponibilite`
  MODIFY `id_disponibilite` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `equipements_armement`
  MODIFY `id_arme` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `especes`
  MODIFY `id_espece` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `faiblesses`
--
ALTER TABLE `faiblesses`
  MODIFY `id_faiblesse` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `forces`
--
ALTER TABLE `forces`
  MODIFY `id_force` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `gameplay_type`
--
ALTER TABLE `gameplay_type`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `gameplay_type_articles`
--
ALTER TABLE `gameplay_type_articles`
...
--
ALTER TABLE `images_objet`
  MODIFY `id_image_obj` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;
...
--
ALTER TABLE `lieux`
  MODIFY `id_lieu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `screens`
  MODIFY `id_screen` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `categories_articles`
  ADD CONSTRAINT `id_cat_article_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `categories_especes`
--
ALTER TABLE `categories_especes`
  ADD CONSTRAINT `id_cat_espece_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `categories_lieux`
--
ALTER TABLE `categories_lieux`
  ADD CONSTRAINT `id_cat_lieu_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `categorie_arm_fps`
--
ALTER TABLE `categorie_arm_fps`
  ADD CONSTRAINT `id_cat_arm_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `categorie_matiere_premier`
--
ALTER TABLE `categorie_matiere_premier`
  ADD CONSTRAINT `id_cat_mat_pre_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `categorie_transport`
--
ALTER TABLE `categorie_transport`
  ADD CONSTRAINT `id_cat_transp_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `couleur`
  ADD CONSTRAINT `id_cat_couleur_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `disponibilite`
  ADD CONSTRAINT `id_cat_disponib_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `faiblesses`
--
ALTER TABLE `faiblesses`
  ADD CONSTRAINT `id_cat_faibl_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `forces`
--
ALTER TABLE `forces`
  ADD CONSTRAINT `id_cat_force_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `gameplay_type`
--
ALTER TABLE `gameplay_type`
  ADD CONSTRAINT `id_cat_type_article_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `gameplay_type_articles`
--
ALTER TABLE `gameplay_type_articles`
  ADD CONSTRAINT `id_gameplay_type_article` FOREIGN KEY (`id_article`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `id_gameplay_type_type` FOREIGN KEY (`id_gameplay_type`) REFERENCES `gameplay_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `objet_type`
  ADD CONSTRAINT `id_obj_type_user` FOREIGN KEY (`id_user_obj_type`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `risque`
  ADD CONSTRAINT `id_cat_risque_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `taille_arm_vaisseau`
--
ALTER TABLE `taille_arm_vaisseau`
  ADD CONSTRAINT `id_cat_taill_user` FOREIGN KEY (`id_user_cat`) REFERENCES `utilisateurs` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `transport_arm`
--
ALTER TABLE `transport_arm`
  ADD CONSTRAINT `id_arm_transp_arm` FOREIGN KEY (`id_arm_transp`) REFERENCES `arm_vaiss` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `id_arm_transp_transp` FOREIGN KEY (`id_transport`) REFERENCES `equipements_transports` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `utilisateurs`
  ...
  ADD CONSTRAINT `id_type_user` FOREIGN KEY (`id_type`) REFERENCES `type_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
