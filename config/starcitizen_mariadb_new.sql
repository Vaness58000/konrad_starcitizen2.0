...
-- Généré le : dim. 26 fév. 2023 à 09:57
...
INSERT INTO `categories_especes` (`id_categ_espece`, `nom`, `validation`) VALUES
(1, 'humain', 1);
...
INSERT INTO `faiblesses` (`id_faiblesse`, `nom_faiblesse`) VALUES
(1, 'faiblesse1');
...
INSERT INTO `forces` (`id_force`, `nom_force`) VALUES
(1, 'force1');
...
INSERT INTO `risque` (`id`, `nom`) VALUES
(1, 'aucun');
...
INSERT INTO `taille_arm_vaisseau` (`id`, `taille`) VALUES
(1, '1');
...
--
ALTER TABLE `images_objet`
  MODIFY `id_image_obj` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=176;
