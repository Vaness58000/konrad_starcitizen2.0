    ...
    <div class="footer-content">
        ...
        <div class="info">
            ...
            <div class="footer-menu">
                <ul class="f-menu">
                    <li><a class="radio" href="info_legale.php">Informations légales</a></li>
                    <li><a class="radio" href="cgu.php">CGU</a></li>
                    <li><a class="radio" href="politique_confi.php">Politique de confidentialités</a></li>
                </ul>
            </div>
        </div>
    </div>
