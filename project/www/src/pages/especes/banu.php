...
<section class="page_ville">
    ...
    <div class="info_ville">
        <h2>Politique</h2>
        <p>République de planètes-états dont chacune dispose de son propre système politique. Les dirigeants (ou les représentants choisis) de chaque planète se réunissent en assemblée pour discuter et débattre des affaires légales et commerciales qui ont une influence sur l'ensemble de l'espèce. Autrement, chacun est livré à lui-même pour réussir ou échouer.</p>

        <p>Leur système de planètes-états est un lourd fardeau qui pèse sur leur autonomie, mais les Banu disposent néanmoins d'un système pour voter des lois inter-espèces. C'est un processus de longue haleine dont les débats durent plusieurs semaines, voire parfois des mois.</p>


    </div>
    <div class="info_ville">
        <h2>Mondes contrôlés</h2>
        <p>Les systèmes sous contrôle Banu ne sont pas hostiles à la présence des humains, mais ils protègent tout de même jalousement leurs secrets. Bien que les Banu soient très dispersés, c'est une race très unie, et qui, lorsqu'elle est rassemblée, est dite capable de tenir tête à chacune des autres espèces intelligentes en même temps. Les humains restent les bienvenus dans leurs systèmes, tant qu'ils respectent leurs règles et leurs lois.</p>
        <p>Bacchus, Geddon, Gliese, Kins, Ophos, Trise, Yulin</p>
    ...
    <div class="info_ville">
        ...
        <p>Humains : Allié<br>
            Xi’an : Amical<br>
            Vanduul : Relation précaire. Les relations varient de planète en planète mais en général, l'attrait de l'argent et du commerce est plus fort que la loyauté et les rancunes.</p>
    ...
    <div class="info_ville">
        <h2>Criminalité</h2>
        <p>La criminalité est très élevée dans le Protectorat Banu. Le manque de communication entre les différentes planètes-états signifie que les criminels peuvent simplement passer d'un monde à l'autre pour ne plus être inquiété. Étant donné que ni l'UEE, ni même l'Advocacy ne sont autorisés à poursuivre les criminels au-delà de la frontière, le Protectorat Banu est un véritable refuge pour les criminels de l'UEE. Et par les voies officielles, très peu de planètes Banu se donnent la peine d'extrader les fugitifs. Cette situation a obligé l'Advocacy à envoyer des agents infiltrés pour traquer, capturer puis ramener discrètement les fugitifs dans l'espace de l'UEE.</p>

        <p>Beaucoup de planètes Banu sont des lieux privilégiés pour le marché noir et les marchandises volées par les pirates sur le territoire de l'UEE peuvent y être vendues à bas prix.</p>
    </div>
    <div class="info_ville">
        <h2>Religion</h2>
        <p>Les Banu sont polythéistes. Sans surprise, les deux divinités ayant le plus d’influence et de fidèles sont Cassa, le patron de la chance, et Taernin, le grand voyageur.</p>

        <p>Le centre spirituel de la société Banu est situé dans le système Trise. Alors que les assemblées convoquées sur le système Bacchus légifèrent sur les questions juridiques et politiques du protectorat, le ‘’Conseil de Trise’’ est responsable des dogmes moraux et sociaux qui définissent et dirigent toute la société Banu.</p>

        <p>Leur tâche nécessitant la plus grande objectivité à propos de leurs semblables, les membres de ce ‘’Conseil’’ se tiennent, autant que possible, à l’écart du reste de leur peuple. Il n’y a aucun grand pèlerinage, et il ne faut donc pas s’attendre à ce que des adorateurs mystiques Banu affluent vers le système Trise. L’isolement du Conseil est la loi. Les moines produisent des œuvres d’art élaborées à partir de cuivre raffiné qui ont une certaine valeur sur les marchés d’art ancien et leurs guérisseurs concoctent une variété de médicaments dont l’effet positif sur les maladies humaines a notamment pu être observé.</p>
    </div>
</section>