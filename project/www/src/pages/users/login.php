...
<div class="page_connect">
    <section class="container-login">
        ...
        <form action="?ind=connexion" method="post">
            <div id="fade-box">
                <?php
                ...
                <a href="?ind=reinitialisation_mdp" class="login__forgot">Mot de passe oublié ?</a>
                <a href="?ind=inscription" class="login__forgot">Pas de compte ? s'inscrire</a>
