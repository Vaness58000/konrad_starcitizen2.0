...
if (!class_exists('CatForcesRepository')) {
    ...
    class CatForcesRepository extends Repository {
        ...
        public function findAll():array {
            return $this->setSql('SELECT * FROM forces')->fetchAllAssoc();
        }
        ...
        public function findAllOrder(bool $orderName = false):array {
            ...
            return $this->setSql('SELECT * FROM forces ORDER BY '.$order)->fetchAllAssoc();
        }

        public function findAllId(int $id):array {
            return $this->setSql('SELECT * FROM forces WHERE id_force=:id')->setParamInt(":id", $id)->fetchAssoc();
        }
        ...
        public function findAllAndPage(int $nmPage=0, int $nbArtPage=0, bool $orderName = false):array {
            ...
            $sql = 'SELECT * FROM forces ORDER BY '.$order.$limit.'';
