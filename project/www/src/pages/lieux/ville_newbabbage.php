...
<section class="page_generale">
    ...
    <div class="info_generale">
        ...
        <img src="src/img/ville23.jpg" alt="ville New Babbage">
        <p>Dans Star Citizen, New Babbage est le siège social de l'entreprise Microtech. Elle est logiquement située sur la planète de l'entreprise, Stanton IV. Inventeur du Mobiglas, la compagnie tente d'être toujours à la pointe de la technologie. Pour faciliter le travail de ses chercheurs, l'entreprise met à disposition des commodités exceptionnelles. La ville est, par conséquent, riche en activité sportive, en restaurant et en zone naturelle. L'environnement a été pensé pour que le scientifique soit au top de sa forme pour trouver la dernière pépite qui fera fructifier les affaires de l'entreprise.<br>
            <br>Cet espace de travail remarquable attire les nombreuses start-up de l'empire et New Babbage est devenu rapidement un incubateur d'entreprise.
        </p>
    ...
    <div class="info_generale">
        ...
        <li>Location de vaisseau Regal</li>
        <li>Hangar pour véhicule terrestre</li>
        <li>Hangar à vaisseau</li>
        <img src="src/img/ville37.png" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville38.png" alt="ville New Babbage">
            <img src="src/img/ville39.png" alt="ville New Babbage">
        </div>
    ...
    <div class="info_generale">
        ...
        <p>Les autres métro de Stanton font pâle figure devant celui de New Babbage. Son design est épuré, la majorité de la coque est vitrée et les armatures sont d'une blancheur immaculée. Sa technologie avant-gardiste lui permet d'atteindre une vitesse maximale nettement supérieure.<br>
            ...
            Grand Line vous permettra de transiter entre le Spatioport, les Commons et Grand Aspire. Vous trouverez ci-dessous le plan du métro.</p>

        <img src="src/img/ville40.png" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville41.png" alt="ville New Babbage">
            <img src="src/img/ville42.png" alt="ville New Babbage">
        </div>
    </div>
    <div class="info_generale">
        <h2>Les Commons</h2>
        ...
        <li>Le restaurant Ellroy's</li>
        <li>Le restaurant Garcia Green's</li>
        <li>Hangars à véhicule terrestre</li>
        <img src="img/ville43.png" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville44.png" alt="ville New Babbage">
            <img src="src/img/ville45.png" alt="ville New Babbage">
        </div>
    </div>
    <div class="info_generale">
        <h2>La Plaza</h2>
        ...
        <img src="src/img/ville46.jpg" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville47.png" alt="ville New Babbage">
            <img src="src/img/ville48.png" alt="ville New Babbage">
        </div>
    ...
    <div class="info_generale">
        ...
        <img src="src/img/ville49.jpg" alt="ville New Babbage">
    ...
    <div class="info_generale">
        ...
        <p>Service disponible :</p>
        <li>Restaurant Whammer</li>
        <li>Magasin de vêtements Apparelli</li>
        <img src="src/img/ville50.png" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville51.png" alt="ville New Babbage">
            <img src="src/img/ville52.png" alt="ville New Babbage">
        </div>
    ...
    <div class="info_generale">
        ...
        <img src="src/img/ville53.jpg" alt="ville New Babbage">
        <div class="gallery_ville">
            <img src="src/img/ville54.png" alt="ville New Babbage">
            <img src="src/img/ville55.png" alt="ville New Babbage">
        </div>
    </div>
</section>