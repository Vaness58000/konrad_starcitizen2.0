"use strict";
add_exec_tab = "./src/exec/objet/add_mod_arm_vaiss.php";
add_line_tab = "add_arm_vaiss";
mod_line_tab = "mod_arm_vaiss";
delete_line_tab = "./src/exec/objet/delete_arm_vaiss.php";
